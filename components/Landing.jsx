    ...
    <>
      ...
      <div className="bg-black text-white tracking-widest w-screen h-screen flex flex-col justify-between absolute top-0 left-0 z-10">
        <div className="px-20 z-10">
          ...
          <div className="flex items-center justify-center text-center tracking-widest">
            Securely acess real-time market data, execute trades with
            confidence,
          ...
          <div className="flex items-center justify-center">
            <button
              className="bg-gradient-to-b from-[#EDC02B] to-[#F8EA76] px-20 rounded-lg py-4 text-black font-bold tracking-widest hover:scale-110 transition-all duration-300"
